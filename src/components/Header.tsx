...
export default function Header() {
  ...
  return (
    <div className="w-full min-w-0 flex flex-col items-center">
      ...
      <nav className="flex gap-1.5 mb-10 bg-accent-mist rounded-full p-1 max-w-full overflow-x-auto no-scrollbar">
        {TABS.map((t) => (
          <Link
            key={t.href}
            href={t.href}
            className={`shrink-0 whitespace-nowrap px-4 py-1.5 rounded-full text-sm transition-colors ${
              pathname === t.href
